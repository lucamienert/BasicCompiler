...
import io.lucamienert.basic.instruction.*;

public class CodeGeneratorX86_64 extends CodeGenerator {

    private final Writer writer;

    public CodeGeneratorX86_64(Writer writer) {
        this.writer = writer;
    }
    ...
    public void generate(InstructionSequence seq) throws IOException {
        ...
        for (Instruction instruction : seq.getInstructions()) {
            switch (instruction.getOpcode()) {
                ...
                case PUSHI:
                    writer.append("  push 0x" + Integer.toHexString(instruction.getIntOperand().get()) + "\n");
                    break;
